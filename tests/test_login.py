...
#             {"username": TEST_USER, "exp": datetime.utcnow() + timedelta(minutes=15)},
#             "wrong_secret_key",
#             algorithm=ALGORITHM
#         )
...
#             {"username": None, "exp": datetime.utcnow() + timedelta(minutes=15)},
#             SECRET_KEY,
#             algorithm=ALGORITHM
#         )
...
#     from your_module import create_access_token  # замените your_module на имя вашего модуля
