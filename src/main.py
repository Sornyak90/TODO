...
async def lifespan(app: FastAPI):
    ...
    if fake_users_str is None:
        fake_users = {}  # или None, или другое значение по умолчанию
    else:
...
if __name__ == "__main__":
    uvicorn.run("main:app", host="0.0.0.0", port=8000, reload=True)  # запускаем приложение с автообновлением
